      ...
      <Section id="contact" eyebrow="Let’s talk" title="Contact">
        <div className="rounded-2xl border border-neutral-800 bg-neutral-950/40 p-6 shadow-soft">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            <a className="rounded-xl border border-neutral-800 bg-neutral-900/40 px-4 py-3 hover:border-indigo-500/50 transition" href="mailto:your.email@example.com">
            ...
            <a className="rounded-xl border border-neutral-800 bg-neutral-900/40 px-4 py-3 hover:border-indigo-500/50 transition" href="https://www.linkedin.com/" target="_blank" rel="noreferrer">
            ...
            <a className="rounded-xl border border-neutral-800 bg-neutral-900/40 px-4 py-3 hover:border-indigo-500/50 transition" href="https://github.com/" target="_blank" rel="noreferrer">
